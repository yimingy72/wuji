...
const schema32 = {"type":"object","additionalProperties":false,"required":["user_id","display_name","csrf_token","expires_at","permissions_version"],"properties":{"user_id":{"type":"string","format":"uuid"},"display_name":{"type":"string","minLength":1,"maxLength":100},"csrf_token":{"type":"string","minLength":1,"maxLength":256},"expires_at":{"type":"string","format":"date-time"},"permissions_version":{"$ref":"urn:wuji:contracts:0.4#/$defs/Version"}}};
...
const err16 = {instancePath:instancePath+"/permissions_version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err16];
}
else {
...
const err17 = {instancePath:instancePath+"/permissions_version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/maximum",keyword:"maximum",params:{comparison: "<=", limit: 9007199254740991},message:"must be <= 9007199254740991"};
if(vErrors === null){
vErrors = [err17];
}
else {
...
const err18 = {instancePath:instancePath+"/permissions_version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err18];
}
else {
...
const schema34 = {"type":"object","additionalProperties":false,"required":["id","tenant_id","name","permissions"],"properties":{"id":{"type":"string","format":"uuid"},"tenant_id":{"type":"string","format":"uuid"},"name":{"type":"string","minLength":1,"maxLength":120},"permissions":{"type":"array","maxItems":10,"items":{"$ref":"urn:wuji:contracts:0.4#/$defs/Permission"}}}};
...
const err13 = {instancePath:instancePath+"/permissions/" + i0,schemaPath:"urn:wuji:contracts:0.4#/$defs/Permission/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err13];
}
else {
...
const err14 = {instancePath:instancePath+"/permissions/" + i0,schemaPath:"urn:wuji:contracts:0.4#/$defs/Permission/enum",keyword:"enum",params:{allowedValues: schema35.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err14];
}
else {
...
const schema36 = {"type":"object","additionalProperties":false,"required":["items","next_cursor"],"properties":{"items":{"type":"array","maxItems":100,"items":{"$ref":"urn:wuji:contracts:0.4#/$defs/Project"}},"next_cursor":{"type":["string","null"],"minLength":1,"maxLength":512}}};
...
const schema38 = {"type":"object","additionalProperties":false,"required":["policy_id","version"],"properties":{"policy_id":{"type":"string","format":"uuid"},"version":{"$ref":"urn:wuji:contracts:0.4#/$defs/Version"}}};
...
const err5 = {instancePath:instancePath+"/version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err5];
}
else {
...
const err6 = {instancePath:instancePath+"/version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/maximum",keyword:"maximum",params:{comparison: "<=", limit: 9007199254740991},message:"must be <= 9007199254740991"};
if(vErrors === null){
vErrors = [err6];
}
else {
...
const err7 = {instancePath:instancePath+"/version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err7];
}
else {
...
const err33 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/required",keyword:"required",params:{missingProperty: "max_total_requests"},message:"must have required property '"+"max_total_requests"+"'"};
if(vErrors === null){
vErrors = [err33];
}
else {
...
const err34 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/required",keyword:"required",params:{missingProperty: "requests_per_second"},message:"must have required property '"+"requests_per_second"+"'"};
if(vErrors === null){
vErrors = [err34];
}
else {
...
const err35 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/required",keyword:"required",params:{missingProperty: "max_concurrent_requests"},message:"must have required property '"+"max_concurrent_requests"+"'"};
if(vErrors === null){
vErrors = [err35];
}
else {
...
const err36 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/required",keyword:"required",params:{missingProperty: "request_timeout_seconds"},message:"must have required property '"+"request_timeout_seconds"+"'"};
if(vErrors === null){
vErrors = [err36];
}
else {
...
const err37 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/required",keyword:"required",params:{missingProperty: "max_response_bytes"},message:"must have required property '"+"max_response_bytes"+"'"};
if(vErrors === null){
vErrors = [err37];
}
else {
...
const err38 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/required",keyword:"required",params:{missingProperty: "max_runtime_seconds"},message:"must have required property '"+"max_runtime_seconds"+"'"};
if(vErrors === null){
vErrors = [err38];
}
else {
...
const err39 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key1},message:"must NOT have additional properties"};
if(vErrors === null){
vErrors = [err39];
}
else {
...
const err40 = {instancePath:instancePath+"/limits/max_total_requests",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_total_requests/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err40];
}
else {
...
const err41 = {instancePath:instancePath+"/limits/max_total_requests",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_total_requests/maximum",keyword:"maximum",params:{comparison: "<=", limit: 200},message:"must be <= 200"};
if(vErrors === null){
vErrors = [err41];
}
else {
...
const err42 = {instancePath:instancePath+"/limits/max_total_requests",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_total_requests/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err42];
}
else {
...
const err43 = {instancePath:instancePath+"/limits/requests_per_second",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/requests_per_second/maximum",keyword:"maximum",params:{comparison: "<=", limit: 2},message:"must be <= 2"};
if(vErrors === null){
vErrors = [err43];
}
else {
...
const err44 = {instancePath:instancePath+"/limits/requests_per_second",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/requests_per_second/exclusiveMinimum",keyword:"exclusiveMinimum",params:{comparison: ">", limit: 0},message:"must be > 0"};
if(vErrors === null){
vErrors = [err44];
}
else {
...
const err45 = {instancePath:instancePath+"/limits/requests_per_second",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/requests_per_second/type",keyword:"type",params:{type: "number"},message:"must be number"};
if(vErrors === null){
vErrors = [err45];
}
else {
...
const err46 = {instancePath:instancePath+"/limits/max_concurrent_requests",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_concurrent_requests/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err46];
}
else {
...
const err47 = {instancePath:instancePath+"/limits/max_concurrent_requests",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_concurrent_requests/maximum",keyword:"maximum",params:{comparison: "<=", limit: 2},message:"must be <= 2"};
if(vErrors === null){
vErrors = [err47];
}
else {
...
const err48 = {instancePath:instancePath+"/limits/max_concurrent_requests",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_concurrent_requests/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err48];
}
else {
...
const err49 = {instancePath:instancePath+"/limits/request_timeout_seconds",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/request_timeout_seconds/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err49];
}
else {
...
const err50 = {instancePath:instancePath+"/limits/request_timeout_seconds",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/request_timeout_seconds/maximum",keyword:"maximum",params:{comparison: "<=", limit: 10},message:"must be <= 10"};
if(vErrors === null){
vErrors = [err50];
}
else {
...
const err51 = {instancePath:instancePath+"/limits/request_timeout_seconds",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/request_timeout_seconds/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err51];
}
else {
...
const err52 = {instancePath:instancePath+"/limits/max_response_bytes",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_response_bytes/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err52];
}
else {
...
const err53 = {instancePath:instancePath+"/limits/max_response_bytes",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_response_bytes/maximum",keyword:"maximum",params:{comparison: "<=", limit: 1048576},message:"must be <= 1048576"};
if(vErrors === null){
vErrors = [err53];
}
else {
...
const err54 = {instancePath:instancePath+"/limits/max_response_bytes",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_response_bytes/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err54];
}
else {
...
const err55 = {instancePath:instancePath+"/limits/max_runtime_seconds",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_runtime_seconds/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err55];
}
else {
...
const err56 = {instancePath:instancePath+"/limits/max_runtime_seconds",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_runtime_seconds/maximum",keyword:"maximum",params:{comparison: "<=", limit: 600},message:"must be <= 600"};
if(vErrors === null){
vErrors = [err56];
}
else {
...
const err57 = {instancePath:instancePath+"/limits/max_runtime_seconds",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_runtime_seconds/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err57];
}
else {
...
const err58 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err58];
}
else {
...
const schema41 = {"type":"object","additionalProperties":false,"required":["items","next_cursor"],"properties":{"items":{"type":"array","maxItems":100,"items":{"$ref":"urn:wuji:contracts:0.4#/$defs/ApprovedScope"}},"next_cursor":{"type":["string","null"],"minLength":1,"maxLength":512}}};
...
const err18 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/required",keyword:"required",params:{missingProperty: "max_total_requests"},message:"must have required property '"+"max_total_requests"+"'"};
if(vErrors === null){
vErrors = [err18];
}
else {
...
const err19 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/required",keyword:"required",params:{missingProperty: "requests_per_second"},message:"must have required property '"+"requests_per_second"+"'"};
if(vErrors === null){
vErrors = [err19];
}
else {
...
const err20 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/required",keyword:"required",params:{missingProperty: "max_concurrent_requests"},message:"must have required property '"+"max_concurrent_requests"+"'"};
if(vErrors === null){
vErrors = [err20];
}
else {
...
const err21 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/required",keyword:"required",params:{missingProperty: "request_timeout_seconds"},message:"must have required property '"+"request_timeout_seconds"+"'"};
if(vErrors === null){
vErrors = [err21];
}
else {
...
const err22 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/required",keyword:"required",params:{missingProperty: "max_response_bytes"},message:"must have required property '"+"max_response_bytes"+"'"};
if(vErrors === null){
vErrors = [err22];
}
else {
...
const err23 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/required",keyword:"required",params:{missingProperty: "max_runtime_seconds"},message:"must have required property '"+"max_runtime_seconds"+"'"};
if(vErrors === null){
vErrors = [err23];
}
else {
...
if(!((((((key1 === "max_total_requests") || (key1 === "requests_per_second")) || (key1 === "max_concurrent_requests")) || (key1 === "request_timeout_seconds")) || (key1 === "max_response_bytes")) || (key1 === "max_runtime_seconds"))){
const err24 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key1},message:"must NOT have additional properties"};
if(vErrors === null){
vErrors = [err24];
}
else {
...
const err25 = {instancePath:instancePath+"/limits/max_total_requests",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_total_requests/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err25];
}
else {
...
const err26 = {instancePath:instancePath+"/limits/max_total_requests",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_total_requests/maximum",keyword:"maximum",params:{comparison: "<=", limit: 200},message:"must be <= 200"};
if(vErrors === null){
vErrors = [err26];
}
else {
...
const err27 = {instancePath:instancePath+"/limits/max_total_requests",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_total_requests/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err27];
}
else {
...
const err28 = {instancePath:instancePath+"/limits/requests_per_second",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/requests_per_second/maximum",keyword:"maximum",params:{comparison: "<=", limit: 2},message:"must be <= 2"};
if(vErrors === null){
vErrors = [err28];
}
else {
...
const err29 = {instancePath:instancePath+"/limits/requests_per_second",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/requests_per_second/exclusiveMinimum",keyword:"exclusiveMinimum",params:{comparison: ">", limit: 0},message:"must be > 0"};
if(vErrors === null){
vErrors = [err29];
}
else {
...
const err30 = {instancePath:instancePath+"/limits/requests_per_second",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/requests_per_second/type",keyword:"type",params:{type: "number"},message:"must be number"};
if(vErrors === null){
vErrors = [err30];
}
else {
...
const err31 = {instancePath:instancePath+"/limits/max_concurrent_requests",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_concurrent_requests/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err31];
}
else {
...
const err32 = {instancePath:instancePath+"/limits/max_concurrent_requests",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_concurrent_requests/maximum",keyword:"maximum",params:{comparison: "<=", limit: 2},message:"must be <= 2"};
if(vErrors === null){
vErrors = [err32];
}
else {
...
const err33 = {instancePath:instancePath+"/limits/max_concurrent_requests",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_concurrent_requests/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err33];
}
else {
...
const err34 = {instancePath:instancePath+"/limits/request_timeout_seconds",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/request_timeout_seconds/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err34];
}
else {
...
const err35 = {instancePath:instancePath+"/limits/request_timeout_seconds",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/request_timeout_seconds/maximum",keyword:"maximum",params:{comparison: "<=", limit: 10},message:"must be <= 10"};
if(vErrors === null){
vErrors = [err35];
}
else {
...
const err36 = {instancePath:instancePath+"/limits/request_timeout_seconds",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/request_timeout_seconds/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err36];
}
else {
...
const err37 = {instancePath:instancePath+"/limits/max_response_bytes",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_response_bytes/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err37];
}
else {
...
const err38 = {instancePath:instancePath+"/limits/max_response_bytes",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_response_bytes/maximum",keyword:"maximum",params:{comparison: "<=", limit: 1048576},message:"must be <= 1048576"};
if(vErrors === null){
vErrors = [err38];
}
else {
...
const err39 = {instancePath:instancePath+"/limits/max_response_bytes",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_response_bytes/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err39];
}
else {
...
const err40 = {instancePath:instancePath+"/limits/max_runtime_seconds",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_runtime_seconds/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err40];
}
else {
...
const err41 = {instancePath:instancePath+"/limits/max_runtime_seconds",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_runtime_seconds/maximum",keyword:"maximum",params:{comparison: "<=", limit: 600},message:"must be <= 600"};
if(vErrors === null){
vErrors = [err41];
}
else {
...
const err42 = {instancePath:instancePath+"/limits/max_runtime_seconds",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/properties/max_runtime_seconds/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err42];
}
else {
...
const err43 = {instancePath:instancePath+"/limits",schemaPath:"urn:wuji:contracts:0.4#/$defs/Limits/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err43];
}
else {
...
const err22 = {instancePath:instancePath+"/input_digest",schemaPath:"urn:wuji:contracts:0.4#/$defs/Sha256/pattern",keyword:"pattern",params:{pattern: "^[a-f0-9]{64}$"},message:"must match pattern \""+"^[a-f0-9]{64}$"+"\""};
if(vErrors === null){
vErrors = [err22];
}
else {
...
const err23 = {instancePath:instancePath+"/input_digest",schemaPath:"urn:wuji:contracts:0.4#/$defs/Sha256/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err23];
}
else {
...
const schema46 = {"type":"object","additionalProperties":false,"required":["id","tenant_id","project_id","name","target_url","scope","version","state","cleanup_state","execution","allowed_actions","assessment_outcome","stop_reason","created_at","updated_at"],"properties":{"id":{"type":"string","format":"uuid"},"tenant_id":{"type":"string","format":"uuid"},"project_id":{"type":"string","format":"uuid"},"name":{"type":"string","minLength":1,"maxLength":120},"target_url":{"type":"string","format":"uri","maxLength":2048,"pattern":"^https?://"},"scope":{"$ref":"urn:wuji:contracts:0.4#/$defs/ScopeBinding"},"version":{"$ref":"urn:wuji:contracts:0.4#/$defs/Version"},"state":{"$ref":"urn:wuji:contracts:0.4#/$defs/TaskState"},"cleanup_state":{"type":"string","enum":["not_required","pending","cleaning","cleaned","cleanup_pending"]},"execution":{"$ref":"urn:wuji:contracts:0.4#/$defs/ExecutionSummary"},"allowed_actions":{"type":"array","maxItems":3,"items":{"$ref":"urn:wuji:contracts:0.4#/$defs/TaskAction"}},"assessment_outcome":{"type":"string","enum":["criteria_met","partial","inconclusive","not_assessed"]},"stop_reason":{"type":["string","null"],"enum":[null,"criteria_met","plan_exhausted","budget_exhausted","deadline_exceeded","user_cancelled","runtime_error","authorization_expired"]},"created_at":{"type":"string","format":"date-time"},"updated_at":{"type":"string","format":"date-time"}},"allOf":[{"if":{"properties":{"state":{"enum":["completed","cancelled","failed"]}},"type":"object"},"then":{"properties":{"execution":{"properties":{"active_calls":{"const":0},"unknown_calls":{"const":0},"egress_state":{"enum":["revoked","not_granted"]}},"type":"object"},"allowed_actions":{"maxItems":0,"type":"array"}},"type":"object"}},{"if":{"properties":{"state":{"const":"paused"}},"type":"object"},"then":{"properties":{"execution":{"properties":{"active_calls":{"const":0},"unknown_calls":{"const":0},"egress_state":{"const":"frozen"}},"type":"object"}},"type":"object"}}]};
...
if(!(((typeof data17 == "number") && (!(data17 % 1) && !isNaN(data17))) && (isFinite(data17)))){
const err47 = {instancePath:instancePath+"/version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err47];
}
else {
...
const err48 = {instancePath:instancePath+"/version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/maximum",keyword:"maximum",params:{comparison: "<=", limit: 9007199254740991},message:"must be <= 9007199254740991"};
if(vErrors === null){
vErrors = [err48];
}
else {
...
if(data17 < 1 || isNaN(data17)){
const err49 = {instancePath:instancePath+"/version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err49];
}
else {
...
const err50 = {instancePath:instancePath+"/state",schemaPath:"urn:wuji:contracts:0.4#/$defs/TaskState/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err50];
}
else {
...
const err51 = {instancePath:instancePath+"/state",schemaPath:"urn:wuji:contracts:0.4#/$defs/TaskState/enum",keyword:"enum",params:{allowedValues: schema48.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err51];
}
else {
...
const err54 = {instancePath:instancePath+"/execution",schemaPath:"urn:wuji:contracts:0.4#/$defs/ExecutionSummary/required",keyword:"required",params:{missingProperty: "active_calls"},message:"must have required property '"+"active_calls"+"'"};
if(vErrors === null){
vErrors = [err54];
}
else {
...
const err55 = {instancePath:instancePath+"/execution",schemaPath:"urn:wuji:contracts:0.4#/$defs/ExecutionSummary/required",keyword:"required",params:{missingProperty: "unknown_calls"},message:"must have required property '"+"unknown_calls"+"'"};
if(vErrors === null){
vErrors = [err55];
}
else {
...
const err56 = {instancePath:instancePath+"/execution",schemaPath:"urn:wuji:contracts:0.4#/$defs/ExecutionSummary/required",keyword:"required",params:{missingProperty: "egress_state"},message:"must have required property '"+"egress_state"+"'"};
if(vErrors === null){
vErrors = [err56];
}
else {
...
const err57 = {instancePath:instancePath+"/execution",schemaPath:"urn:wuji:contracts:0.4#/$defs/ExecutionSummary/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key1},message:"must NOT have additional properties"};
if(vErrors === null){
vErrors = [err57];
}
else {
...
const err58 = {instancePath:instancePath+"/execution/active_calls",schemaPath:"urn:wuji:contracts:0.4#/$defs/ExecutionSummary/properties/active_calls/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err58];
}
else {
...
const err59 = {instancePath:instancePath+"/execution/active_calls",schemaPath:"urn:wuji:contracts:0.4#/$defs/ExecutionSummary/properties/active_calls/maximum",keyword:"maximum",params:{comparison: "<=", limit: 9007199254740991},message:"must be <= 9007199254740991"};
if(vErrors === null){
vErrors = [err59];
}
else {
...
const err60 = {instancePath:instancePath+"/execution/active_calls",schemaPath:"urn:wuji:contracts:0.4#/$defs/ExecutionSummary/properties/active_calls/minimum",keyword:"minimum",params:{comparison: ">=", limit: 0},message:"must be >= 0"};
if(vErrors === null){
vErrors = [err60];
}
else {
...
const err61 = {instancePath:instancePath+"/execution/unknown_calls",schemaPath:"urn:wuji:contracts:0.4#/$defs/ExecutionSummary/properties/unknown_calls/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err61];
}
else {
...
const err62 = {instancePath:instancePath+"/execution/unknown_calls",schemaPath:"urn:wuji:contracts:0.4#/$defs/ExecutionSummary/properties/unknown_calls/maximum",keyword:"maximum",params:{comparison: "<=", limit: 9007199254740991},message:"must be <= 9007199254740991"};
if(vErrors === null){
vErrors = [err62];
}
else {
...
const err63 = {instancePath:instancePath+"/execution/unknown_calls",schemaPath:"urn:wuji:contracts:0.4#/$defs/ExecutionSummary/properties/unknown_calls/minimum",keyword:"minimum",params:{comparison: ">=", limit: 0},message:"must be >= 0"};
if(vErrors === null){
vErrors = [err63];
}
else {
...
const err64 = {instancePath:instancePath+"/execution/egress_state",schemaPath:"urn:wuji:contracts:0.4#/$defs/ExecutionSummary/properties/egress_state/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err64];
}
else {
...
const err65 = {instancePath:instancePath+"/execution/egress_state",schemaPath:"urn:wuji:contracts:0.4#/$defs/ExecutionSummary/properties/egress_state/enum",keyword:"enum",params:{allowedValues: schema49.properties.egress_state.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err65];
}
else {
...
const err66 = {instancePath:instancePath+"/execution",schemaPath:"urn:wuji:contracts:0.4#/$defs/ExecutionSummary/type",keyword:"type",params:{type: "object"},message:"must be object"};
if(vErrors === null){
vErrors = [err66];
}
else {
...
const err68 = {instancePath:instancePath+"/allowed_actions/" + i0,schemaPath:"urn:wuji:contracts:0.4#/$defs/TaskAction/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err68];
}
else {
...
const err69 = {instancePath:instancePath+"/allowed_actions/" + i0,schemaPath:"urn:wuji:contracts:0.4#/$defs/TaskAction/enum",keyword:"enum",params:{allowedValues: schema50.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err69];
}
else {
...
const schema51 = {"type":"object","additionalProperties":false,"required":["items","next_cursor"],"properties":{"items":{"type":"array","maxItems":100,"items":{"$ref":"urn:wuji:contracts:0.4#/$defs/Task"}},"next_cursor":{"type":["string","null"],"minLength":1,"maxLength":512}}};
...
const schema52 = {"type":"object","additionalProperties":false,"required":["task","event_cursor"],"properties":{"task":{"$ref":"urn:wuji:contracts:0.4#/$defs/Task"},"event_cursor":{"$ref":"urn:wuji:contracts:0.4#/$defs/Cursor"}}};
...
if(typeof data1 === "string"){
if(func1(data1) > 512){
const err3 = {instancePath:instancePath+"/event_cursor",schemaPath:"urn:wuji:contracts:0.4#/$defs/Cursor/maxLength",keyword:"maxLength",params:{limit: 512},message:"must NOT have more than 512 characters"};
if(vErrors === null){
vErrors = [err3];
}
else {
...
if(func1(data1) < 1){
const err4 = {instancePath:instancePath+"/event_cursor",schemaPath:"urn:wuji:contracts:0.4#/$defs/Cursor/minLength",keyword:"minLength",params:{limit: 1},message:"must NOT have fewer than 1 characters"};
if(vErrors === null){
vErrors = [err4];
}
else {
...
const err5 = {instancePath:instancePath+"/event_cursor",schemaPath:"urn:wuji:contracts:0.4#/$defs/Cursor/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err5];
}
else {
...
const err24 = {instancePath:instancePath+"/accepted_task_version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err24];
}
else {
...
const err25 = {instancePath:instancePath+"/accepted_task_version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/maximum",keyword:"maximum",params:{comparison: "<=", limit: 9007199254740991},message:"must be <= 9007199254740991"};
if(vErrors === null){
vErrors = [err25];
}
else {
...
const err26 = {instancePath:instancePath+"/accepted_task_version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err26];
}
else {
...
const err27 = {instancePath:instancePath+"/request_digest",schemaPath:"urn:wuji:contracts:0.4#/$defs/Sha256/pattern",keyword:"pattern",params:{pattern: "^[a-f0-9]{64}$"},message:"must match pattern \""+"^[a-f0-9]{64}$"+"\""};
if(vErrors === null){
vErrors = [err27];
}
else {
...
const err28 = {instancePath:instancePath+"/request_digest",schemaPath:"urn:wuji:contracts:0.4#/$defs/Sha256/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err28];
}
else {
...
const schema57 = {"type":"object","additionalProperties":false,"required":["items","next_cursor","has_more"],"properties":{"items":{"type":"array","maxItems":100,"items":{"$ref":"urn:wuji:contracts:0.4#/$defs/TaskEvent"}},"next_cursor":{"$ref":"urn:wuji:contracts:0.4#/$defs/Cursor"},"has_more":{"type":"boolean"}}};
const schema58 = {"type":"object","additionalProperties":false,"required":["schema_version","event_id","cursor","tenant_id","project_id","task_id","aggregate_version","type","occurred_at","trace_id","summary"],"properties":{"schema_version":{"type":"string","const":"1.0"},"event_id":{"type":"string","format":"uuid"},"cursor":{"$ref":"urn:wuji:contracts:0.4#/$defs/Cursor"},"tenant_id":{"type":"string","format":"uuid"},"project_id":{"type":"string","format":"uuid"},"task_id":{"type":"string","format":"uuid"},"aggregate_version":{"$ref":"urn:wuji:contracts:0.4#/$defs/Version"},"type":{"type":"string","enum":["task.changed","task.cleanup_changed","artifact.available"]},"occurred_at":{"type":"string","format":"date-time"},"trace_id":{"type":"string","format":"uuid"},"summary":{"type":"string","minLength":1,"maxLength":500}}};
...
if(typeof data2 === "string"){
if(func1(data2) > 512){
const err16 = {instancePath:instancePath+"/cursor",schemaPath:"urn:wuji:contracts:0.4#/$defs/Cursor/maxLength",keyword:"maxLength",params:{limit: 512},message:"must NOT have more than 512 characters"};
if(vErrors === null){
vErrors = [err16];
}
else {
...
if(func1(data2) < 1){
const err17 = {instancePath:instancePath+"/cursor",schemaPath:"urn:wuji:contracts:0.4#/$defs/Cursor/minLength",keyword:"minLength",params:{limit: 1},message:"must NOT have fewer than 1 characters"};
if(vErrors === null){
vErrors = [err17];
}
else {
...
const err18 = {instancePath:instancePath+"/cursor",schemaPath:"urn:wuji:contracts:0.4#/$defs/Cursor/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err18];
}
else {
...
if(!(((typeof data6 == "number") && (!(data6 % 1) && !isNaN(data6))) && (isFinite(data6)))){
const err25 = {instancePath:instancePath+"/aggregate_version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/type",keyword:"type",params:{type: "integer"},message:"must be integer"};
if(vErrors === null){
vErrors = [err25];
}
else {
...
const err26 = {instancePath:instancePath+"/aggregate_version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/maximum",keyword:"maximum",params:{comparison: "<=", limit: 9007199254740991},message:"must be <= 9007199254740991"};
if(vErrors === null){
vErrors = [err26];
}
else {
...
if(data6 < 1 || isNaN(data6)){
const err27 = {instancePath:instancePath+"/aggregate_version",schemaPath:"urn:wuji:contracts:0.4#/$defs/Version/minimum",keyword:"minimum",params:{comparison: ">=", limit: 1},message:"must be >= 1"};
if(vErrors === null){
vErrors = [err27];
}
else {
...
if(typeof data2 === "string"){
if(func1(data2) > 512){
const err6 = {instancePath:instancePath+"/next_cursor",schemaPath:"urn:wuji:contracts:0.4#/$defs/Cursor/maxLength",keyword:"maxLength",params:{limit: 512},message:"must NOT have more than 512 characters"};
if(vErrors === null){
vErrors = [err6];
}
else {
...
if(func1(data2) < 1){
const err7 = {instancePath:instancePath+"/next_cursor",schemaPath:"urn:wuji:contracts:0.4#/$defs/Cursor/minLength",keyword:"minLength",params:{limit: 1},message:"must NOT have fewer than 1 characters"};
if(vErrors === null){
vErrors = [err7];
}
else {
...
const err8 = {instancePath:instancePath+"/next_cursor",schemaPath:"urn:wuji:contracts:0.4#/$defs/Cursor/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err8];
}
else {
...
const err5 = {instancePath:instancePath+"/code",schemaPath:"#/properties/code/enum",keyword:"enum",params:{allowedValues: schema62.properties.code.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err5];
}
else {
