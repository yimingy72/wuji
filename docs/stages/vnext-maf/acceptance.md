...
| P06 模型/工具准入与累计账本 | test-first in-progress | [实施合同](../../vnext/P06-implementation-contract.md)；SOL Curie `01a09869` 负责测试，GPT-6 Faraday `01a0981b` 负责核心实现；迁移、UoW、OpenAPI 与生成 DTO 所有权在最终交接前仍属 P06 |
| P07—P12 开发和机制验收 | not_run | [P07 实施合同](../../vnext/P07-implementation-contract.md)已由主代理设计；其余按依赖执行，未验证不标通过 |
