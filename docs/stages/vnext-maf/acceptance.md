...
| P08、P10—P12 完整机制验收 | not_run / not accepted | 本表不以 P09 局部验证或迁移关口替代其完整运行验收；具体下游切片按各自记录 |
| P13 受权图投影与持久视图 | backend runtime verified / M4 partial | core `3015ca6`、P04 existing-tx port `592bed2`、0012迁移与测试 `44ddc68`；[真实结果](../../vnext/evidence/P13/runtime-green/report.md)为 12 项通过，覆盖 nonowner PG、签名 HTTP、固定分页/详情、历史、当前权限、隐藏依据、opaque cursor、无执行及 safe-field Run 来源；[完整 HTTP](../../vnext/evidence/P13/runtime-green/http-reproduction.md)与[截图](../../vnext/evidence/P13/runtime-green/screenshots/p13-runtime.jpg)已保存。纯 builder 9项复用未重跑。Layout、ViewStream、P14正式容器与后续P12类型仍未验收，故不标 M4 全过 |
