...
const validatorSchemas = {
  ...
  validateAssessmentView: 'AssessmentView',
  validateObservationPage: 'ObservationPage',
  validateVerificationPage: 'VerificationPage',
  validateVerificationDetail: 'VerificationDetail',
  validateError: 'Error',
};
